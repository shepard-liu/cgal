...
int main() {
  ...
  auto cstxcurve = traits.construct_x_monotone_curve_2_object();
  ...
  arcs.push_back(construct(Polynomial(1), x));
  arcs.push_back(construct(Polynomial(20), x));
