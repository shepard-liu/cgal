...
public:
  ...
  Make_x_monotone_2 make_x_monotone_2_object() const {
    const Derived* derived = static_cast<const Derived*>(this);
    return Make_x_monotone_2(derived->traits(),
                             derived->m_counters[Derived::MAKE_X_MONOTONE_2_OP]);
  }
};
...
public:
  ...
  Are_mergeable_2 are_mergeable_2_object() const {
    const Derived* derived = static_cast<const Derived*>(this);
    return Are_mergeable_2(derived->traits(),
                           derived->m_counters[Derived::ARE_MERGEABLE_2_OP]);
  }
};
...
public:
  ...
  Merge_2 merge_2_object() const {
    const Derived* derived = static_cast<const Derived*>(this);
    return Merge_2(derived->traits(),
                   derived->m_counters[Derived::MERGE_2_OP]);
  }
};
...
public:
  ...
  Construct_opposite_2 construct_opposite_2_object() const {
    const Derived* derived = static_cast<const Derived*>(this);
    return Construct_opposite_2(derived->traits(),
                                derived->m_counters[Derived::CONSTRUCT_2_OPPOSITE_2_OP]);
  }
};
...
public:
  ...
  Compare_endpoints_xy_2 compare_endpoints_xy_2_object() const {
    const Derived* derived = static_cast<const Derived*>(this);
    return Compare_endpoints_xy_2(derived->traits(),
                                  derived->m_counters[Derived::COMPARE_ENDPOINTS_XY_2_OP]);
  }
};
...
public:
  ...
  Compare_y_near_boundary_2 compare_y_near_boundary_2_object() const {
    const Derived* derived = static_cast<const Derived*>(this);
    return Compare_y_near_boundary_2(derived->traits(),
                                     derived->m_counters[Derived::COMPARE_Y_NEAR_BOUNDARY_2_OP]);
  }
};
...
public:
  ...
  Compare_x_near_boundary_2 compare_x_near_boundary_2_object() const {
    const Derived* derived = static_cast<const Derived*>(this);
    return Compare_x_near_boundary_2(derived->traits(),
                                     derived->m_counters[Derived::COMPARE_X_NEAR_BOUNDARY_2_OP]);
  }
};
